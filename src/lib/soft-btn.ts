...
export const SOFT_BTN =
  "border-2 border-primary/20 bg-primary/10 text-primary shadow-none hover:bg-primary/20 hover:text-primary dark:border-primary/35 dark:bg-primary/15 dark:hover:bg-primary/25";
